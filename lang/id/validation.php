...
return [
    ...
    'max'                  => [
        ...
        'string'  => 'Isian tidak boleh lebih panjang dari :max karakter.',
    ],
    ...
    'min'                  => [
        ...
        'string'  => 'Isian harus berisi minimal :min karakter.',
    ],
    ...
    'unique'               => 'Isian ini sudah digunakan sebelumnya.',
    ...
    'custom'               => [
        'end_date' => [
            'before' => 'Tanggal Akhir maksimal diisi tanggal hari ini'
        ],
        'attribute-name' => [
